...
/**
 * ReducedCommunityQuestionHeader component displays the header section for a list of questions, but without the ask question button.
 *
 ...
 */
const ReducedCommunityQuestionHeader = ({
  titleText,
  qcnt,
  setQuestionOrder,
}: QuestionHeaderProps) => (
...
export default ReducedCommunityQuestionHeader;
